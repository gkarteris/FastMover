(function($, window, document, undefined) {
    ...
    var Self, display, videoSelect, lastImageSrc, con, beepSound, w, h, lastCode,
        ...
        defaults = {
            ...
            zoom: 0,
            beep: '../QR/webcodecamjs-master/audio/beep.mp3',
            decoderWorker: '../QR/webcodecamjs-master/js/DecoderWorker.js',
            brightness: 0,
                ...
                setTimeout(function() {
                    if (Self.options.codeRepetition || lastCode != a) {
                        ...
                        $(document).ready(function () {
                            createCookie("myCode", my_QR_Code, "20");
                        });
    ...
    $.extend(Plugin.prototype, {
        init: function() {
            if (!initialized) {
                ...
                if (this.options.decodeQRCodeRate) {
                    setCallBack();
                }
            }
            return this;
